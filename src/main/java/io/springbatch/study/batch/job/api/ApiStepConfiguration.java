package io.springbatch.study.batch.job.api;

import io.springbatch.study.batch.chunk.processor.ApiItemProcessor1;
import io.springbatch.study.batch.chunk.processor.ApiItemProcessor2;
import io.springbatch.study.batch.chunk.processor.ApiItemProcessor3;
import io.springbatch.study.batch.chunk.processor.ProcessorClassifier;
import io.springbatch.study.batch.chunk.writer.ApiItemWriter1;
import io.springbatch.study.batch.chunk.writer.ApiItemWriter2;
import io.springbatch.study.batch.chunk.writer.ApiItemWriter3;
import io.springbatch.study.batch.chunk.writer.WriterClassifier;
import io.springbatch.study.batch.domain.ApiRequestVO;
import io.springbatch.study.batch.domain.ProductVO;
import io.springbatch.study.batch.partition.ProductPartitioner;
import io.springbatch.study.service.ApiService1;
import io.springbatch.study.service.ApiService2;
import io.springbatch.study.service.ApiService3;
